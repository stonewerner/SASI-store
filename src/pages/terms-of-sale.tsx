  ...
  return (
    <div className="max-w-2xl mx-auto prose prose-blue">
      ...
      <p>
        ...
        wrong with your order, please let us know by contacting us at stoneandspencerinc@gmail.com!
      </p>

      <h2>Do you offer refunds?</h2>
      <p>
        Refunds are only offered to customers that receive the wrong items or
        damaged items. If any of these apply, please contact us at stoneandspencerinc@gmail.com
        with photos of wrong/damaged items and we&apos;ll
      ...
      <p>
        ...
        that&apos;s the case, please let us know at stoneandspencerinc@gmail.com
        within a week after receiving your order. Include your order
